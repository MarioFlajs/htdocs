        ...
        <ul class="navListMenu">
          ...
          <li class="navList">
            <form class="searchForm" action="action_page.php">
              ...
              <input class="searchInput" type="text"  placeholder="Search..Oak, Saw.." name="search" value>
